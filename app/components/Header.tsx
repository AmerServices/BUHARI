...
const Header = () => {
  ...
  const services = [
    {
      title: 'Amer Center',
      link: '/services/amer-center',
      sub: [
        { title: 'Golden Visa', link: '/services/golden-visa-uae' },
        { title: 'Family Visa', link: '/services/uae-family-visa' },
        { title: 'Employment Visa', link: '/services/uae-work-visa' },
        { title: 'Tourist Visa', link: '/services/travel-visa' },
        { title: 'Visit Visa', link: '/services/visit-visa' },
        { title: 'Emirates ID', link: '/services/emirates-id' },
        { title: 'Medical Services', link: '/services/medical-clinic-dubai' },
        { title: 'Status Change', link: '/services/change-visa-status' },
        { title: 'Data Modification', link: '/services/data-modification' },
      ],
    },
    {
      title: 'Tasheel Dubai',
      link: '/services/tasheel-dubai',
      sub: [
        { title: 'Work Permit', link: '/services/work-permit' },
        { title: 'Signature Card', link: '/services/visa-signature-card' },
        { title: 'Establishment File', link: '/services/emiratisation' },
        { title: 'Job Offer Letter', link: '/services/job-offer-letter' },
        { title: 'MOL Insurance', link: '/services/mol-insurance' },
        { title: 'Labour Contract', link: '/services/ministry-of-labour' },
        { title: 'PRO Card', link: '/services/uae-labour-card' },
        { title: 'Employee Reports', link: '/services/employee-reports' },
      ],
    },
    {
      ...
      sub: [
        { title: 'Mainland', link: '/services/business-setup-in-dubai-mainland' },
        { title: 'Free Zone', link: '/services/uae-free-zone' },
        { title: 'Trade License', link: '/services/trade-license' },
        { title: 'MOA Issuance', link: '/services/memorandum-of-association-uae' },
        { title: 'PRO Services', link: '/services/pro-services-dubai' },
        { title: 'Office Space and Ejari', link: '/services/office-space-ejari' },
        { title: 'Bank Account', link: '/services/bank-account-in-uae' },
      ],
    },
    {
      title: 'Dubai Economic Department',
      link: '/services/dubai-economic-department',
    },
    {
      title: 'Legal Advisor in Dubai',
      link: '/services/legal-advisor-in-dubai',
      sub: [
        { title: 'Legal Translation', link: '/services/legal-translation' },
        { title: 'Notary Services', link: '/services/notary-services' },
        { title: 'Power of Attorney', link: '/services/legal-attorney' },
        { title: 'Affidavit', link: '/services/affidavit' },
        { title: 'Memorandum', link: '/services/memorandum-of-association' },
      ],
    },
    {
      title: 'Dubai Police Services',
      link: '/services/dubai-police-services',
    },
    {
      title: 'RTA Services',
      link: '/services/rta-services',
    },
  ];

  return (
    <div className='w-full shadow-lg fixed top-0 z-[100]'>
    <div className="h-[80px] md:h-[100px] 2xl:h-[120px] bg-gn text-white my-auto">
      <div className="w-full h-full flex items-center justify-between md:justify-around">
        <Link href="/" className="flex items-center justify-start px-2 ">
          <Image src="/logo.webp" alt="Logo" width={200} height={200} style={{ height: 'auto' }} priority className="w-[150px] lg:w-[200px] object-cover" />
        </Link>
        <ul className=" hidden md:flex text-sm 2xl:text-base font-medium items-center gap-4 lg:gap-10 xl:gap-16 relative z-50">
                    ...
                    {activeSubMenu === service.title && service.sub && (
                      <ul className="absolute left-full top-0 bg-gn shadow-lg w-48">
                        {service.sub.map((item, index) => (
                          <li key={index} className="px-4 py-2 hover:bg-gray-100 text-white hover:text-gn w-full h-full">
                            <Link href={item.link} className='h-full w-full'>{item.title}</Link>
                          </li>
                        ))}
                      </ul>
                    )}
      ...
      {/* Search Bar */}
      {showSearchBar && (
        <div className="bg-black bg-opacity-50 w-full px-4 py-4 animate-slide-down pt-12 xl:pt-16">
          <div className="relative w-[80%] lg:max-w-2xl flex items-center bg-white rounded-full mx-auto">
            <input
              ...
              className="w-full px-4 py-2 rounded-full border text-black border-gray-300 focus:outline-none focus:ring-2 focus:ring-gre"
              autoFocus />
            <button
            ...
            <li>
              ...
              {isDropdownOpen && (
                <ul
                  ...
                  className="p-2 text-sm flex flex-col gap-4 bg-gn text-"
                >
                  {services.map((service) => (
      ...
      {isOpen && (
        <ul className="py-4 px-2 mt-2 flex flex-col gap-2 bg-gn">
          {service.sub.map((subItem) => (
            <li key={subItem.title} className='p-2 h-8 flex items-center justify-between active:bg-gn'>

...
import { contactContent } from '../../data/other';
...
const ContactUsSection = () => {
  return (
    <section className="py-10 xlg:py-20 px-4 sm:px-6 md:px-10 xl:px-28 xlg:px-48">
      <div className="flex flex-col lg:flex-row justify-center bg-white shadow-2xl overflow-hidden">
        ...
        {/* Right Section */}
        <AnimateInView direction='right' className="p-8 bg-white flex flex-col justify-start relative flex-1 min-h-[600px] no-scrollbar">
          <h3 className="text font-bold border-b-[3px] border-rd w-fit uppercase tracking-widest mb-8 text-center lg:text-left">
            <span className='text-rd'>{contactContent.messageForm.heading}</span>
          </h3>
          <iframe

...
const cardDesigns = [
  {
    ...
    titleColor: 'text-black lg:text-white uppercase',
    border: 'border-gn',
  ...
  },
  {
    mainBg: 'bg-white bg-opacity-20 backdrop-blur-sm',
    iconBg: 'bg-white bg-opacity-20 backdrop-blur-sm',
    titleColor: 'text-black lg:text-white uppercase font-bold',
    border: 'border-gn',
    hoverEffect: 'hover:shadow-lg hover:scale-[1.01]',
  },
];
...
const ServicesCarousel = () => {
  return (
    <Marquee
      ...
      pauseOnHover={true}
      direction="left"
      className="relative overflow-hidden pt-10 lg:py-4"
    >
      <div id="services-carousel" className="flex gap-4 pl-4">

...
import { contactInfo } from '../data/other';

const HeaderContacts = () => {
  return (
    <div
      className="flex sticky justify-end h-[30px] sm:h-[40px] gap-5 items-center py-2 px-4 md:px-10 text-white w-full md:pr-5 text-sm bg-black"
    >

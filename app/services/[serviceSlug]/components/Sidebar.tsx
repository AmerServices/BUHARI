...
import { Service } from '../../../interface/service'; // Adjust path if necessary
...
const SubServiceSidebar: React.FC<SubServiceSidebarProps> = ({
  ...
  return (
    ...
    <AnimateInView
      direction="left"
      className="sticky top-[160px] lg:m-0 min-w-[220px] rounded-xl bg-gn text-white p-4 shadow-md" // Adjusted margin, added shadow, and default bg
    >
